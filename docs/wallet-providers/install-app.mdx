...
This endpoint handles both new installations and re-enabling previously uninstalled apps:
- **New installation**: Mints a new [PKP](https://developer.litprotocol.com/user-wallets/pkps/overview) and permits the app
- **Re-enabling**: If the user previously uninstalled the app, automatically detects this and re-enables it with the existing PKP
