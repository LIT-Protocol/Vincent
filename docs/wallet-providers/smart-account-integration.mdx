...
<Columns cols={3}>
  <Card title="ZeroDev Integration" icon="cube" href="/api-reference/wallet/zerodev" color="#FF4205">
    Kernel-based smart accounts
  </Card>
  <Card title="Crossmint Integration" icon="wallet" href="/api-reference/wallet/crossmint" color="#FF4205">
    Managed smart wallets
  </Card>
  <Card title="Safe Integration" icon="shield" href="/api-reference/wallet/safe" color="#FF4205">
