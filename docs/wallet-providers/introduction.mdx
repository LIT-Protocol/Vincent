...
| [POST /user/:appId/install-app](/wallet-providers/install-app) | Initiate app installation |
...
| [POST /user/:appId/repermit-app](/wallet-providers/repermit-app) | Initiate permission re-grant |
| [POST /user/:appId/complete-repermit](/wallet-providers/complete-repermit) | Complete permission re-grant |
