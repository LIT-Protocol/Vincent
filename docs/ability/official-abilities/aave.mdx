...
<Tabs>
  ...
  <Tab title="Withdraw">
    **Requirements for Withdraw Operation:**
  ...
  <Tab title="Borrow">
    **Requirements for Borrow Operation:**
  ...
  <Tab title="Repay">
    **Requirements for Repay Operation:**
...
| **Testnets** | `sepolia`, `basesepolia`, `arbitrumsepolia`, `optimismsepolia`, `avalanchefuji`, `scrollsepolia` |
...
<AccordionGroup>
  ...
  <Accordion title="Chain Parameter vs RPC URL" icon="link">
  ...
  <Accordion title="Health Factor Management" icon="heart-pulse">
