...
library LibVincentUserFacet {
    ...
    event NewAgentRegistered(
        address indexed userAddress, address indexed agentAddress, address indexed pkpSigner, uint256 pkpSignerPubKey
    );
