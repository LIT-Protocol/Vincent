...
const injectedRtkApi = api
  ...
  .injectEndpoints({
    endpoints: (build) => ({
      ...
      unpermitApp: build.mutation<UnpermitAppApiResponse, UnpermitAppApiArg>({
        query: (queryArg) => ({
          url: `/user/${encodeURIComponent(String(queryArg.appId))}/unpermit-app`,
          method: 'POST',
          body: queryArg.unpermitAppRequest,
        }),
        invalidatesTags: ['User'],
      }),
      completeUnpermit: build.mutation<CompleteUnpermitApiResponse, CompleteUnpermitApiArg>({
        query: (queryArg) => ({
          url: `/user/${encodeURIComponent(String(queryArg.appId))}/complete-unpermit`,
          method: 'POST',
          body: queryArg.completeUnpermitRequest,
        }),
        invalidatesTags: ['User'],
      }),
      repermitApp: build.mutation<RepermitAppApiResponse, RepermitAppApiArg>({
        query: (queryArg) => ({
          url: `/user/${encodeURIComponent(String(queryArg.appId))}/repermit-app`,
          method: 'POST',
          body: queryArg.repermitAppRequest,
        }),
        invalidatesTags: ['User'],
      }),
      completeRepermit: build.mutation<CompleteRepermitApiResponse, CompleteRepermitApiArg>({
        query: (queryArg) => ({
          url: `/user/${encodeURIComponent(String(queryArg.appId))}/complete-repermit`,
          method: 'POST',
          body: queryArg.completeRepermitRequest,
        }),
        invalidatesTags: ['User'],
      }),
...
export type UnpermitAppApiResponse =
  /** status 200 Unpermit data returned successfully */ UnpermitAppResponse;
export type UnpermitAppApiArg = {
  /** ID of the target application */
  appId: number;
  unpermitAppRequest: UnpermitAppRequest;
};
export type CompleteUnpermitApiResponse =
  /** status 200 Unpermit completed successfully */ CompleteUnpermitResponse;
export type CompleteUnpermitApiArg = {
  /** ID of the target application */
  appId: number;
  completeUnpermitRequest: CompleteUnpermitRequest;
};
export type RepermitAppApiResponse =
  /** status 200 Repermit data returned successfully */ RepermitAppResponse;
export type RepermitAppApiArg = {
  /** ID of the target application */
  appId: number;
  repermitAppRequest: RepermitAppRequest;
};
export type CompleteRepermitApiResponse =
  /** status 200 Repermit completed successfully */ CompleteRepermitResponse;
export type CompleteRepermitApiArg = {
  /** ID of the target application */
  appId: number;
  completeRepermitRequest: CompleteRepermitRequest;
};
...
export type UnpermitAppResponse = {
  /** The EIP2771 TypedData to sign that will unpermit the app from the Vincent contracts */
  unpermitDataToSign: {};
};
export type UnpermitAppRequest = {
  /** The version of the app to unpermit */
  appVersion: number;
  /** EOA address that controls the user smart wallet */
  userControllerAddress: string;
};
export type CompleteUnpermitResponse = {
  /** The transaction hash of the completed unpermit transaction */
  transactionHash: string;
};
export type CompleteUnpermitRequest = {
  /** The signature of the typed data from the user wallet */
  typedDataSignature: string;
  /** The unpermitDataToSign object returned from unpermit-app. Generated by the Gelato SDK. */
  unpermitDataToSign: {};
};
export type RepermitAppResponse = {
  /** The EIP2771 TypedData to sign that will repermit the app in the Vincent contracts */
  repermitDataToSign: {};
};
export type RepermitAppRequest = {
  /** EOA address that controls the user smart wallet */
  userControllerAddress: string;
};
export type CompleteRepermitResponse = {
  /** The transaction hash of the completed repermit transaction */
  transactionHash: string;
};
export type CompleteRepermitRequest = {
  /** The signature of the typed data from the user wallet */
  typedDataSignature: string;
...
export const {
  ...
  useUnpermitAppMutation,
  useCompleteUnpermitMutation,
  useRepermitAppMutation,
  useCompleteRepermitMutation,
  useGetAgentFundsMutation,
} = injectedRtkApi;
