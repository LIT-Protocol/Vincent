...
export type RequestWithdrawResponse = {
  ...
  withdrawals: {
    ...
    network: string;
    /** The ERC-4337 UserOperation to sign. Contains callData, gas limits, and paymaster data. User must sign the UserOperation hash with their EOA. */
    userOp: {};
  }[];
};
