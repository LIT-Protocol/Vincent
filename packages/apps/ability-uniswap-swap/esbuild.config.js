          ...
          }),
          {
            ...
            setup(build) {
              ...
              build.onEnd(async (result) => {
                ...
                const prepareSource = getPrepareCode();
                const preparePath = path.resolve('./src/generated/vincent-prepare-metadata.ts');
                fs.writeFileSync(preparePath, prepareSource);
              });
            },
          },
        ],
