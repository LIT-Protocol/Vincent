  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'focus-visible:ring-orange-500/50 dark:focus-visible:ring-orange-400/50 focus-visible:ring-[3px]',
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className={cn('size-4', theme.textMuted)} />
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          'bg-white dark:bg-gray-950 text-gray-900 dark:text-white border-gray-200 dark:border-white/20',
          position === 'popper' &&
