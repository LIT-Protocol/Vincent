            ...
            >
              <div className="relative grid grid-cols-1 md:grid-cols-2 min-h-[300px] md:min-h-[500px]">
                ...
                <div className="p-8 flex flex-col justify-center order-2 md:order-1">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400 mb-4" style={fonts.body}>
                    Integrate Vincent to enable automation and delegation for traditional EOAs and
                    Smart Accounts across chains
                  </div>
                  <a
                    href="https://docs.heyvincent.ai/wallet-providers"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-6 py-3 text-sm font-medium text-gray-900 dark:text-white hover:gap-3 hover:text-[#FF4205] transition-all group mx-auto rounded-full border-2 border-gray-900 dark:border-white hover:border-[#FF4205] no-underline"
                    style={fonts.heading}
                  >
                    Get Started
                    <svg
                ...
                {/* Right side - mesh gradient with wallet preview overlay */}
                <div className="flex items-center justify-center overflow-hidden relative order-1 md:order-2">
                  <img
                    src="/backgrounds/image-mesh-gradient.png"
                    alt="Mesh gradient"
                  ...
                  />
                  <img
                    src="/backgrounds/wallet-preview.png"
                    alt="Wallet integration preview"
                    className="relative z-10 max-h-[250px] md:max-h-[400px] w-auto object-contain py-4 md:py-8"
                  />
                </div>
              </div>
